    ...
    <div>
        <div className="grid lg:grid-cols-2">
...

              {
                deliveries.map((delivery,index) => (
                  <div key={index} className="my-10 sm:mx-10">
                    <h1 className="text-indigo-600 font-semibold">{delivery.heading}</h1>
                    <p className="mt-2 text-2xl font-bold text-gray-900 uppercase">{delivery.title}</p>
                    <div className="mt-4">
                      {delivery.list.map((list,index) => (
                       <div key={index} className="flex flex-wrap space-x-2 py-3">
                          ...
                          <div className="text-gray-900 font-semibold">{list.sub}</div>
                    ...
                    <button className="btn capitalize bg-white text-primary rounded-md border-gray-300 shadow-sm px-5 py-3 font-medium hover:bg-primary hover:text-white hover:shadow-lg transition duration-400 ease-in-out mt-8">Learn More</button>
            ...
            <div className="m-[30px]">
              <img src={CarouselImg} alt="" className=""/>
            </div>
        </div>
